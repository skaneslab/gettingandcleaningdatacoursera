...
tidy_data_set (180 rows, 86 columns) is created by using the group_by() function in R to group by subject and activity and by summarizing it taking the means of each variable for each activity and each subject
